...
fp32 INS_angle_a[3] = {0.0f, 0.0f, 0.0f};
...
void INS_task(void const *pvParameters)
{
    ...
    HAL_GPIO_WritePin(lLED_R_GPIO_Port,lLED_R_Pin,GPIO_PIN_SET);
    while(BMI088_init())
    {
        osDelay(100);
    }
    ...
    while (1)
    {
        ...
        get_angle(INS_quat, INS_angle + INS_YAW_ADDRESS_OFFSET, INS_angle + INS_PITCH_ADDRESS_OFFSET, INS_angle + INS_ROLL_ADDRESS_OFFSET);
				...
				imu_angle.ax = bmi088_real_data.accel[0];
				imu_angle.ay = bmi088_real_data.accel[1];
				imu_angle.az = bmi088_real_data.accel[2];
				imu_angle.gx = bmi088_real_data.gyro[0]*57.3f;
				imu_angle.gy = bmi088_real_data.gyro[1]*57.3f;
				imu_angle.gz = bmi088_real_data.gyro[2]*57.3f;
				imu_angle.pitch = INS_angle[1] *57.3f;
				imu_angle.roll = INS_angle[2] *57.3f;
				imu_angle.yaw = INS_angle[0] *57.3f;
				...
				imu_angle.temp = bmi088_real_data.temp;
...
const imu_angle_t* get_imu_angle_point(void){
