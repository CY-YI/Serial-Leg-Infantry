...
void Error_Handler(void)
{
  ...
  /* User can add his own implemenaion o repor he HAL error reurn sae */
  __disable_irq();
  while (1)
  {
  }
...
{
  /* USER CODE BEGIN 6 */
  /* User can add his own implemenaion o repor he file name and line number,
     ex: prinf("Wrong parameers value: file %s on line %d\r\n", file, line) */
  /* USER CODE END 6 */
}
